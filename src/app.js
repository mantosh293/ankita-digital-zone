...
app.use(session({ name: 'ankita.sid', secret: config.sessionSecret, resave: false, saveUninitialized: false, cookie: { httpOnly: true, sameSite: 'lax', secure: config.env === 'production', maxAge: 1000 * 60 * 60 * 8 } }));
app.use(currentUser);
